<!-- Space: Projects -->
<!-- Parent: HelloTauri -->
<!-- Title: Contributing GithubFlow HelloTauri -->
<!-- Label: HelloTauri -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to hello-tauri project on [GitHub](https://github.com/luismayta/hello-tauri), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/hello-tauri/pulls).
...
To follow the instructions in this guide and start contributing to hello-tauri project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/hello-tauri.git
```

Now your **upstream** points to **luismayta/hello-tauri**.
...
git fetch upstream # assuming upstream is luismayta/hello-tauri
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/hello-tauri/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
